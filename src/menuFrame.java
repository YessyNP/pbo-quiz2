...
public class menuFrame extends javax.swing.JFrame {
    ...
    private ArrayList<Items> belanja = new ArrayList<>();
    
    public menuFrame() {
        ComboItems comboModel = new ComboItems();
        this.cbModel = new DefaultComboBoxModel<>(comboModel.getJenisNama().toArray());
        
        Table tabelModel = new Table();
 ...
 //addItem Object
    private  Object[] addItem(String nama, int jumlah){
        float harga = 0;
        ComboItems items = new ComboItems();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(removeButton, javax.swing.GroupLayout.PREFERRED_SIZE, 60, Short.MAX_VALUE)
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try{
            ...
            for(int i = 0; i < tbModel.getRowCount(); i++){
                ...
                int jumlah = new Integer(tbModel.getValueAt(i, 2).toString());
                this.belanja.add(new Items(nama, harga, jumlah));
            }
